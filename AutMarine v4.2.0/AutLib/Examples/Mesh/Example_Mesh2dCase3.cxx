...
void AutLib::Example_Mesh2d::MeshCase3()
{
	Open_OutputFile_TecPlot(Plot, "Example_MeshCase3");
	...
	SizeMap2d_PointsSizeMapTool SizeMap(&Reference, &Box);
	SizeMap.ImportPointPatch("Default Block Point");
