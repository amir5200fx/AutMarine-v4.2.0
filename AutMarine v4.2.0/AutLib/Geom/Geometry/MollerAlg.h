...
#define POINT_IN_TRI(V0,U0,U1,U2)           \
  ...
  if(d0*d1>0.0)                             \
    ...
    if(d0*d2>0.0) return 1;                 \
		...
		inline int coplanar_tri_tri(double N[3], double V0[3], double V1[3], double V2[3], double U0[3], double U1[3], double U2[3])
		{
			double A[3];
			short i0, i1;
...
#define NEWCOMPUTE_INTERVALS(VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,A,B,C,X0,X1) \
		...
		inline int NoDivTriTriIsect(double V0[3], double V1[3], double V2[3], double U0[3], double U1[3], double U2[3])
		{
			double E1[3], E2[3];
