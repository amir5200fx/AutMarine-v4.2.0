#pragma once
#ifndef _QualityMap3d_MinAngle_Header
#define _QualityMap3d_MinAngle_Header
...
namespace AutLib
{
	namespace MeshLib
	{
		...
		class QualityMap3d_MinAngle : public Mesh3d_QualityMap
		{
...
#endif // !_QualityMap3d_MinAngle_Header
