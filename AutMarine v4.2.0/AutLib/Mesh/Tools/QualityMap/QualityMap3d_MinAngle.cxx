...
AutLib::MeshLib::QualityMap3d_MinAngle::QualityMap3d_MinAngle()
{
}

Standard_Real AutLib::MeshLib::QualityMap3d_MinAngle::GetInitialAlpha
(
...
{
	return Mesh3d_QualityMap3dTools::GetInitialAlpha(incidenttets, d, r, RateEpsilon, QualityMap3d_MINANGLE, theWorst);
}

void AutLib::MeshLib::QualityMap3d_MinAngle::GetActiveSet
(
	const TColMesh3d_HAry1dOfOptTetInfo & incidenttets,
...
{
	Mesh3d_QualityMap3dTools::GetActiveSet(incidenttets, theActiveSetFactor, theWorst, QualityMap3d_MINANGLE, theActiveGrads);
}

void AutLib::MeshLib::QualityMap3d_MinAngle::CalcOptInfo(const Global_Handle(Mesh3d_Node) theNode, Mesh3d_OptTetInfo & theTet) const
{
	Mesh3d_QualityMap3dTools::CalcOptInfo(theNode, theTet, QualityMap3d_MINANGLE, 1.0);
}

Standard_Real AutLib::MeshLib::QualityMap3d_MinAngle::CalcQuality
(
