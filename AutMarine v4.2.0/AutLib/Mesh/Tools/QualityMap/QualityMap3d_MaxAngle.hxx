#pragma once
#ifndef _QualityMap3d_MaxAngle_Header
#define _QualityMap3d_MaxAngle_Header
...
namespace AutLib
{
	namespace MeshLib
	{
		...
		class QualityMap3d_MaxAngle : public Mesh3d_QualityMap
		{
...
#endif // !_QualityMap3d_MaxAngle_Header
