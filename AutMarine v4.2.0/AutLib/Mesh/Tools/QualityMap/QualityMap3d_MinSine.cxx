...
AutLib::MeshLib::QualityMap3d_MinSine::QualityMap3d_MinSine()
{
}

Standard_Real AutLib::MeshLib::QualityMap3d_MinSine::GetInitialAlpha
(
...
{
	return Mesh3d_QualityMap3dTools::GetInitialAlpha(incidenttets, d, r, RateEpsilon, QualityMap3d_MINSINE, theWorst);
}

void AutLib::MeshLib::QualityMap3d_MinSine::GetActiveSet
(
	const TColMesh3d_HAry1dOfOptTetInfo & incidenttets,
...
{
	Mesh3d_QualityMap3dTools::GetActiveSet(incidenttets, theActiveSetFactor, theWorst, QualityMap3d_MINSINE, theActiveGrads);
}

void AutLib::MeshLib::QualityMap3d_MinSine::CalcOptInfo(const Global_Handle(Mesh3d_Node) theNode, Mesh3d_OptTetInfo & theTet) const
{
	Mesh3d_QualityMap3dTools::CalcOptInfo(theNode, theTet, QualityMap3d_MINSINE, 1.0);
}

Standard_Real AutLib::MeshLib::QualityMap3d_MinSine::CalcQuality
(
