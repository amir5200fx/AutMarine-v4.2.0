#pragma once
#ifndef _QualityMap3d_WarpedMinSine_Header
#define _QualityMap3d_WarpedMinSine_Header
...
namespace AutLib
{
	namespace MeshLib
	{
		...
		class QualityMap3d_WarpedMinSine : public Mesh3d_QualityMap
		{

		private:

			Standard_Real theSineWarpFactor_;

		public:

			QualityMap3d_WarpedMinSine();
...
#endif // !_QualityMap3d_WarpedMinSine_Header
