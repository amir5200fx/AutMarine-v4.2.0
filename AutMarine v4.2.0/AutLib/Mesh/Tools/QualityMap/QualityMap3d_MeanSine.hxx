#pragma once
#ifndef _QualityMap3d_MeanSine_Header
#define _QualityMap3d_MeanSine_Header
...
namespace AutLib
{
	namespace MeshLib
	{
		...
		class QualityMap3d_MeanSine : public Mesh3d_QualityMap
		{
...
#endif // !_QualityMap3d_MeanSine_Header
